...
Private Sub Form_Resize()
    ...
    If WindowState <> vbMinimized Then
        ...
        PicLines.Left = 30
        PicLines.Top = 300
        PicLines.Height = fraMain(1).Height * Screen.TwipsPerPixelX - 20 - 285
        
        lvwItemes.Left = 30
        lvwItemes.Top = 450
        lvwItemes.Height = fraMain(1).Height * Screen.TwipsPerPixelX - 480
        ...
        tbCodigo.Left = 450
        tbCodigo.Top = 300
        tbCodigo.Width = fraMain(2).Width * Screen.TwipsPerPixelY - 450
        
        rtbCodigo.Left = 450
        rtbCodigo.Top = 630
        rtbCodigo.Height = fraMain(2).Height * Screen.TwipsPerPixelX - 300
        rtbCodigo.Width = fraMain(2).Width * Screen.TwipsPerPixelY - 450
        PicLines.Height = rtbCodigo.Height
...
Public Sub CargaItemes()
    ...
    Do While Not glbRecordset.EOF
        'e = DoEvents
        stbMain.Panels(2).Text = k & " de " & total
        stbMain.Panels(4).Text = Round((k * 100) / total, 0) & " %"
        
        pgbStatus.Value = k
        
        key = "k" & glbRecordset!item
            
        stbMain.Panels(5).Text = Trim$(glbRecordset!descripción)
        
        ValidateRect lvwItemes.hWnd, 0&
        If (k Mod 10) = 0 Then InvalidateRect lvwItemes.hWnd, 0&, 0&
             
        lvwItemes.ListItems.Add , key, Format(k, "0000"), 21, 21
