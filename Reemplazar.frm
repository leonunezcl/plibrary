...
Private Sub Reemplazar(ByVal tipo As Integer)
    ...
    Else
        lPos = 1
        gsBuffer = frmMain.rtbCodigo.Text
    End If
    ...
    frmMain.rtbCodigo.SelStart = 1
    frmMain.rtbCodigo.SelColor = RGB(0, 0, 0)
    frmMain.rtbCodigo.SelLength = Len(gsBuffer)
    frmMain.rtbCodigo.Text = gsBuffer
...
Private Sub Form_Load()
    ...
    gsBuffer = UCase$(frmMain.rtbCodigo.Text)
